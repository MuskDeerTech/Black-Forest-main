...
const Employees = () => {
  ...
  useEffect(() => {
    const fetchEmployeesAndStores = async () => {
      try {
        // Fetch employees
        const employeeResponse = await axios.get(`${import.meta.env.VITE_APP_SERVER_URL}/addusers`);
        setEmployees(employeeResponse.data);

        // Fetch stores (for branches)
        const storeResponse = await axios.get(`${import.meta.env.VITE_APP_SERVER_URL}/stores`);
  ...
  const handleForceLogout = (username) => {
    axios
      .put(`${import.meta.env.VITE_APP_SERVER_URL}/addusers/forceLogout`, { username })
      .then((response) => {
        ...
        setTimeout(() => {
          ...
          axios
            .get(`${import.meta.env.VITE_APP_SERVER_URL}/addusers`)
            .then((response) => {
