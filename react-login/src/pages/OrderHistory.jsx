...
const OrderHistory = () => {
  ...
  const handleSaveNotes = async (e, orderId) => {
    ...
    try {
      const response = await axios.put(`${import.meta.env.VITE_APP_SERVER_URL}/orders/${orderId}/notes`, {
  ...
  const fetchFilteredOrders = async (
    ...
    try {
      ...
      let url = `${import.meta.env.VITE_APP_SERVER_URL}/orders?startDate=${startDate}&endDate=${endDate}&dateField=${dateField}`;
  ...
  const handleMenuClick = async (e, orderId) => {
    ...
    try {
      ...
      await axios.put(`${import.meta.env.VITE_APP_SERVER_URL}/orders/${orderId}/response`, {
